...
weatherObject2.onload = function(){
    ...
    document.getElementById('highTemp2').innerHTML = weatherInfo2.main.temp_max;
    document.getElementById('lowTemp2').innerHTML = weatherInfo2.main.temp_min;
...
weatherObject3.onload = function(){
    ...
    document.getElementById('currentTemp3').innerHTML = weatherInfo3.main.temp;
     document.getElementById('highTemp3').innerHTML = weatherInfo3.main.temp_max;
    document.getElementById('lowTemp3').innerHTML = weatherInfo3.main.temp_min;
